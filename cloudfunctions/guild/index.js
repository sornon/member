...
const ACTION_HANDLER_MAP = Object.freeze({
  ...
  'attributes.overview': 'getGuildAttributes',
  'attributes.upgradeCap': 'upgradeGuildAttributeCap',
  'attributes.upgradeLevel': 'upgradeMemberGuildAttribute',
...
const CUSTOM_ACTIONS = Object.freeze({
  ...
  'admin.listGuilds': async (service, actorId, event = {}, context = {}) =>
    service.adminListGuilds(actorId, event, context),
  'admin.guildDetail': async (service, actorId, event = {}, context = {}) =>
  ...
  'admin.updateGuildSettings': async (service, actorId, event = {}, context = {}) =>
    service.adminUpdateGuildSettings(actorId, event, context),
