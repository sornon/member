...
const SKILL_HIGHLIGHT_CATEGORY_LABELS = {
  damage: '伤害',
  crit: '暴击',
  dot: '持续伤害',
  duration: '持续',
...
const SKILL_PROGRESSION_HIGHLIGHT_MAP = {
  主倍率: { category: 'damage', template: '造成 {value} 攻击伤害' },
  暴击追加伤害: { category: 'crit', template: '暴击额外伤害 {value}' },
  命中倍率: { category: 'damage', template: '造成 {value} 技能伤害' },
  灼烧伤害: { category: 'dot', template: '灼烧每回合造成 {value} 伤害' },
  持续回合: { category: 'duration', template: '效果持续 {value}' },
  减速幅度: { category: 'slow', template: '减速 {value}', absolute: true },
  触发减伤: { category: 'defense', template: '触发减伤 {value}' },
  即时回复: { category: 'heal', template: '立即回复 {value} 生命' },
  反震比例: { category: 'reflect', template: '反震伤害 {value}' },
  灵兽攻击力加成: { category: 'buff', template: '灵兽攻击力提升 {value}' },
  触发回复: { category: 'resource', template: '触发回复 {value} 真气' },
  触发冷却: { category: 'cooldown', template: '触发冷却 {value}' },
  眩晕命中率: { category: 'control', template: '眩晕命中率 {value}' },
  控制时长: { category: 'control', template: '控制持续 {value}' },
  防御削减: { category: 'debuff', template: '降低防御 {value}', absolute: true },
  中毒伤害: { category: 'dot', template: '中毒每回合造成 {value} 伤害' },
  真气上限: { category: 'resource', template: '真气上限提升 {value}' },
  回合回复: { category: 'sustain', template: '每回合回复 {value}' },
  单段倍率: { category: 'damage', template: '单段造成 {value} 伤害' },
  段数: { category: 'mechanic', template: '攻击段数 {value}' },
  剑气附加倍率: { category: 'damage', template: '剑气附加伤害 {value}' },
  易伤幅度: { category: 'debuff', template: '易伤 {value}', absolute: true },
  连锁上限: { category: 'mechanic', template: '最多连锁 {value}' },
  护盾吸收: { category: 'shield', template: '护盾吸收 {value}' },
  反射灼烧: { category: 'reflect', template: '反射灼烧 {value}' },
  爆裂伤害: { category: 'damage', template: '护盾爆裂造成 {value} 伤害' },
  每层攻速: { category: 'buff', template: '每层攻速提升 {value}' },
  每层回气: { category: 'resource', template: '每层回复 {value} 真气' },
  层数上限: { category: 'mechanic', template: '层数上限 {value}' },
  灵兽伤害加成: { category: 'buff', template: '灵兽伤害提升 {value}' },
  技能冷却缩减: { category: 'cooldown', template: '技能冷却缩短 {value}', absolute: true },
  主人下次技能增伤: { category: 'buff', template: '下次技能伤害提升 {value}' },
  沉默命中率: { category: 'control', template: '沉默命中率 {value}' },
  真气回复压制: { category: 'debuff', template: '真气回复减少 {value}', absolute: true },
  抗性提升: { category: 'buff', template: '抗性提升 {value}' },
  敏捷加成: { category: 'buff', template: '敏捷提升 {value}' },
  单格倍率: { category: 'damage', template: '单格造成 {value} 伤害' },
  目标数量: { category: 'mechanic', template: '作用目标 {value}' },
  攻速降低: { category: 'debuff', template: '攻速降低 {value}', absolute: true },
  基础倍率: { category: 'damage', template: '造成 {value} 基础伤害' },
  灼烧追加: { category: 'dot', template: '额外灼烧 {value}' },
  生命回复: { category: 'heal', template: '触发时治疗 {value}' },
  额外火伤: { category: 'damage', template: '额外火焰伤害 {value}' },
  即时治疗: { category: 'heal', template: '立即治疗 {value}' },
  治疗量加成: { category: 'heal', template: '治疗效果提升 {value}' },
  触发冷却缩减: { category: 'cooldown', template: '冷却缩短 {value}', absolute: true },
  触发间隔: { category: 'mechanic', template: '触发间隔 {value}' },
  妖气回复压制: { category: 'debuff', template: '妖气回复减少 {value}', absolute: true },
  冷却时间: { category: 'cooldown', template: '冷却时间 {value}' },
  冻结命中率: { category: 'control', template: '冻结命中率 {value}' },
  破冰伤害: { category: 'damage', template: '破冰造成 {value} 伤害' },
  火势每层加成: { category: 'dot', template: '每层火势增加 {value} 伤害' },
  反射伤害: { category: 'reflect', template: '反射伤害 {value}' },
  减伤幅度: { category: 'defense', template: '减伤 {value}' },
  反击伤害: { category: 'reflect', template: '反击每回合造成 {value}' },
  触发回气: { category: 'resource', template: '触发回复 {value} 真气' },
  增益延长: { category: 'support', template: '增益延长 {value}' },
  范围减速: { category: 'slow', template: '范围减速 {value}', absolute: true },
  治疗压制: { category: 'debuff', template: '治疗效果降低 {value}', absolute: true }
};
...
function resolveHighlightCategoryLabel(category) {
  if (!category) {
    return '';
  }
  return SKILL_HIGHLIGHT_CATEGORY_LABELS[category] || '';
}
...
function formatProgressionValue(entry, level = 1, options = {}) {
  ...
  const rawValue = base + perLevel * extraLevels;
  const format = options.format || entry.format || 'percent';
  const normalizedEntry = { ...entry, format };
  if (options.digits != null) {
    normalizedEntry.digits = options.digits;
  }
  if (options.suffix != null) {
    normalizedEntry.suffix = options.suffix;
  }
  const suffix = resolveProgressionSuffix(normalizedEntry, format);
  const displayValue = options.absolute ? Math.abs(rawValue) : rawValue;
  const formattedNumber = formatProgressionNumber(displayValue, format, normalizedEntry);
...
function buildSkillHighlightSummaries(definition, level = 1) {
  if (!definition || typeof definition !== 'object') {
    return [];
  }
  const entries = Array.isArray(definition.progression) ? definition.progression : [];
  ...
  entries.forEach((entry) => {
    ...
    const config = SKILL_PROGRESSION_HIGHLIGHT_MAP[entry.label];
    if (!config) {
      return;
    }
    const { template = '{value}', category, ...valueOptions } = config;
    const valueText = formatProgressionValue(entry, levelValue, valueOptions);
    if (!valueText) {
      return;
    }
    const categoryLabel = resolveHighlightCategoryLabel(category);
    const prefix = categoryLabel ? `【${categoryLabel}】` : '';
    const finalText = `${prefix}${template.replace('{value}', valueText)}`;
    if (!seen.has(finalText)) {
      seen.add(finalText);
      highlights.push(finalText);
    }
  });
  return highlights;
}
...
module.exports = {
  ...
  SKILL_PROGRESSION_HIGHLIGHT_MAP,
  createBonusSummary,
  applyBonus,
  mergeBonusSummary,
  flattenBonusSummary,
