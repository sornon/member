...
| 属性名 | 中文含义 | 默认值 | 备注 |
| --- | --- | --- | --- |
| `weapon` | 武器槽位是否允许强化 | ✅ 包含于列表 | 作为主输出装备，能吃到强化加成 |
| `armor` | 防具槽位是否允许强化 | ✅ 包含于列表 | 提升生存装备的数值上限 |
| `accessory` | 饰品槽位是否允许强化 | ✅ 包含于列表 | 提供功能/辅助属性也可被强化 |
...
| 属性名 | 中文含义 | 默认值 | 备注 |
| --- | --- | --- | --- |
| `base` | 强化计算使用的基础倍率 | `1`（`v2` 提升到 `1.05`） | v2 统一 +5% 起始强化系数，使同级装备整体提档 |
