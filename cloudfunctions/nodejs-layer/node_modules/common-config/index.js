...
const realmConfigs = [
      ...
      items: [
        {
          ...
          qualityLabel: '权益券',
          qualityColor: '#f2a546',
          iconUrl: buildCloudAssetUrl('item', 'item-5.png')
        }
      ]
    }
  },
  {
    ...
    thresholds: [5000, 5500, 5900, 6600, 7600, 9000, 10800, 12800, 15000, 18000],
    discount: 1,
    virtualRewards: [
      '称号「结丹·初凝」，获得结丹称号',
      '下品武器「青竹剑」，轻巧易上手',
      ...
      items: [
        {
          ...
          qualityLabel: '权益券',
          qualityColor: '#f2a546',
          iconUrl: buildCloudAssetUrl('item', 'item-6.png')
        },
        {
          type: 'equipment',
          itemId: 'spirit_blade',
  ...
  },
  {
    ...
    thresholds: [18500, 19600, 21300, 23600, 26500, 30000, 34000, 38800, 44100, 50000],
    discount: 1,
    virtualRewards: [
  ...
  },
  {
    ...
    thresholds: [51000, 52800, 55600, 59300, 63900, 69400, 75700, 82900, 91000, 100000],
    discount: 1,
    virtualRewards: [
  ...
  },
  {
    ...
    thresholds: [105000, 111100, 118300, 126600, 136000, 146600, 158300, 171100, 185000, 200000],
    discount: 1,
    virtualRewards: [
      '称号「炼虚·洞明」，附带虚化光影；累计充值 ¥105,000 解锁炼虚一层，赠炼虚背景（权益待定，可随时调整）',
      '灵石积分 +3200，用于兑换虚空晶石',
      '头像框「虚空流光」解锁',
      '服饰「雾隐斗篷」上线',
      '法宝「虚影分身」特效挂件',
  ...
  },
  {
    ...
    thresholds: [210000, 222200, 236600, 253300, 272200, 293300, 316600, 342200, 370000, 400000],
    discount: 1,
    virtualRewards: [
      '称号「合体·初合」，显化合体光环；累计充值 ¥210,000 解锁合体一层，赠合体背景（权益待定，可随时调整）',
      '灵石积分 +6400，兑换合体灵材',
      '头像框「合体法相」解锁',
      '服饰「鸿蒙战铠」上线',
      '法宝「法相金身」虚拟模型',
  ...
  },
  {
    ...
    thresholds: [420000, 444400, 473300, 506600, 544400, 586600, 633300, 684400, 740000, 800000],
    discount: 1,
    virtualRewards: [
      '称号「大乘·初悟」，获得道韵光芒；累计充值 ¥420,000 解锁大乘一层，赠大乘背景（权益待定，可随时调整）',
      '灵石积分 +12800，可兑换真仙宝材',
      '头像框「大乘法象」解锁',
      '服饰「苍穹霞衣」上线',
      '法宝「鸿蒙界扇」虚拟特效',
  ...
  },
  {
    ...
    thresholds: [840000, 889000, 946900, 1013500, 1089000, 1173400, 1266700, 1368900, 1480000, 1600000],
    discount: 1,
    virtualRewards: [
      '称号「真仙·初证」，点亮仙辉特效；累计充值 ¥840,000 解锁真仙一层，赠真仙背景（权益待定，可随时调整）',
      '灵石积分 +25600，用于兑换真仙法源',
      '头像框「真仙仙辉」解锁',
      '服饰「仙霄云衣」上线',
      '法宝「太清仙灯」虚拟特效',
  ...
  },
  {
    ...
    thresholds: [2000000, 2110000, 2220000, 2330000, 2440000, 2550000, 2660000, 2770000, 2880000, 3000000],
    discount: 1,
    virtualRewards: [
      '称号「金仙·初耀」，获得仙羽光效；累计充值 ¥2,000,000 解锁金仙一层，赠金仙背景（权益待定，可随时调整）',
      '灵石积分 +51200，可兑换金仙仙材',
      '头像框「金仙圣环」解锁',
      '服饰「金仙羽衣」上线',
      '法宝「九霄云辇」虚拟座驾',
