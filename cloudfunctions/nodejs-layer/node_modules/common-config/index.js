...
const COLLECTIONS = Object.freeze({
  ...
  GUILD_TASKS: 'guildTasks',
  GUILD_BOSS: 'guildBoss',
  GUILD_LEADERBOARD: 'guildLeaderboard',
  GUILD_LOGS: 'guildLogs',
  GUILD_BATTLES: 'guildBattles',
  GUILD_CACHE: 'guildCache',
  GUILD_EVENT_LOGS: 'guildEventLogs',
  GUILD_TICKETS: 'guildTickets',
  GUILD_RATE_LIMITS: 'guildRateLimits',
...
const realmConfigs = [
      ...
      items: [
        {
          ...
          name: '包房体验券',
          description: '使用后获得「包房券」权益，可预约包房体验 1 次。',
          slotLabel: '道具',
          quality: 'epic',
          qualityLabel: '权益券',
          qualityColor: '#f2a546',
  ...
  },
  {
    ...
    discount: 1,
    virtualRewards: [
      '称号「元婴·初现」，展示元神光影；解锁元婴一层，赠元婴背景与包房使用次数 1 次',
    ...
    milestone: {
        type: '包房体验',
        summary: '突破奖励：背景「化神背景」 + 私人包房券 1 次',
        items: [
          {
            type: 'consumable',
            storageItemId: 'reward_voucher_foundation_room',
