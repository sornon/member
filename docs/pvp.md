...
- **快速匹配与好友对战**：支持按积分区间自动匹配、从排行榜入口直接切磋榜单成员以及通过邀请链接发起切磋。若暂时缺乏真人对手，会自动生成平衡的 AI 傀儡。除自动匹配外，其余模式均视为演练赛，不会结算赛季积分与胜负战绩；排行榜切磋次数不限，胜负也不会计入战绩。
...
- **邀战有效期**：分享的邀战令 24 小时后自动失效，过期将无法发起对战，防止长期占用随机种子或复用旧链接刷奖励。【F:cloudfunctions/pvp/index.js†L668-L759】
