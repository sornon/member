...
凡品（`mortal`）装备作为角色的第一阶养成素材，重点在于提供清晰的主属性方向并帮助玩家理解后续品质升级所带来的收益。本节给出一套覆盖 12 个槽位的凡品装备范例，每个槽位至少 3 件。数值以 40 级基值 × 槽位系数 × 凡品系数 0.8 为准，四舍五入到 1 位小数；百分比类主属性已经换算为百分比展示。该列表不包含任何套装或稀有副属性，便于直接投放为新手或前期副本掉落。

### 武器（主属性：基础攻击 / 最终增伤 / 连击率）

| 名称 | 推荐等级 | 主属性（凡品·40 级） | 定位说明 |
| --- | --- | --- | --- |
| 松木练骨刀 | 35-45 | 基础攻击 +270.3 | 朴实的单手刀，提供稳定的基础攻击，适合物理输出入门。 |
| 旧铜律刃 | 35-45 | 最终增伤 +9.6% | 双刃短剑，强调持续增伤，方便体验增伤型流派。 |
| 灵砂连弩 | 35-45 | 连击率 +13.3% | 短弩结构，让玩家提前接触连击机制与爆发玩法。 |

### 头部（主属性：物防 / 法防 / 格挡）

| 名称 | 推荐等级 | 主属性（凡品·40 级） | 定位说明 |
| --- | --- | --- | --- |
| 灰石护额 | 35-45 | 物理防御 +159.4 | 强调物理减伤，适合前排坦克过渡。 |
| 帛纱束冠 | 35-45 | 法术防御 +159.4 | 抗法术伤害的入门头冠，搭配灵力型角色使用。 |
| 青铜面甲 | 35-45 | 格挡率 +14.9% | 让玩家感受格挡触发的收益，适合反击或防御流。 |

### 衣服（主属性：生命% / 减伤 / 护盾强度）

| 名称 | 推荐等级 | 主属性（凡品·40 级） | 定位说明 |
| --- | --- | --- | --- |
| 素纱护衣 | 35-45 | 生命上限倍率 +15.6% | 通过最大生命提升基础坦度，易于理解生命% 的收益。 |
| 背嵌铁甲 | 35-45 | 减伤 +17.9% | 面向副本的通用减伤外衣，帮助玩家稳定承伤。 |
| 云纹软甲 | 35-45 | 护盾强度 +20.6% | 引导玩家搭配护盾技能或词条的思路。 |

### 鞋履（主属性：速度 / 闪避 / 命中）

| 名称 | 推荐等级 | 主属性（凡品·40 级） | 定位说明 |
| --- | --- | --- | --- |
| 鹿皮轻靴 | 35-45 | 速度 +74.1 | 直观提升行动顺序，适配高速或控制流。 |
| 漆羽行履 | 35-45 | 闪避 +69.2 | 让游侠类职业体验闪避收益，强化机动性。 |
| 驭阵战靴 | 35-45 | 命中 +58.1 | 保证早期命中率，减少打空带来的挫败感。 |

### 腰带（主属性：生命% / 受疗 / 治疗强化）

| 名称 | 推荐等级 | 主属性（凡品·40 级） | 定位说明 |
| --- | --- | --- | --- |
| 紧束藤腰 | 35-45 | 生命上限倍率 +14.2% | 与衣服生命% 形成叠加，巩固坦克基础血量。 |
| 棉绸医环 | 35-45 | 受疗加成 +15.8% | 适合前排或治疗自身，提升被治疗收益。 |
| 风铃法带 | 35-45 | 治疗量加成 +15.8% | 奶妈入门腰带，提升输出治疗的效率。 |

### 护腕（主属性：基础攻击 / 反击率 / 格挡）

| 名称 | 推荐等级 | 主属性（凡品·40 级） | 定位说明 |
| --- | --- | --- | --- |
| 凛霜护臂 | 35-45 | 基础攻击 +225.3 | 辅助近战输出补足攻击力，配合武器成套使用。 |
| 回涌腕环 | 35-45 | 反击率 +17.1% | 引导玩家尝试反击流派，与傀儡装备呼应。 |
| 铁叶格挡 | 35-45 | 格挡率 +14.9% | 平衡防守与生存，适合前排控制。 |

### 宝珠（主属性：法攻 / 控制命中 / 最终增伤）

| 名称 | 推荐等级 | 主属性（凡品·40 级） | 定位说明 |
| --- | --- | --- | --- |
| 琉璃灵珠 | 35-45 | 法术攻击 +259.1 | 法系输出过渡装，提供稳定法攻。 |
| 玄霜定魂 | 35-45 | 控制命中 +102.1 | 帮助控制职业堆叠命中阈值。 |
| 烬辉注灵 | 35-45 | 最终增伤 +9.6% | 为术法 DPS 提供额外增伤手段。 |

### 项圈（主属性：控制命中 / 治疗强化 / 怒气获取）

| 名称 | 推荐等级 | 主属性（凡品·40 级） | 定位说明 |
| --- | --- | --- | --- |
| 灵息挂坠 | 35-45 | 控制命中 +97.3 | 让控场角色快速补足命中差距。 |
| 回春环佩 | 35-45 | 治疗量加成 +15.8% | 奶妈角色的常驻项圈，增强技能治疗。 |
| 烈志喉牌 | 35-45 | 怒气获取 +20.6% | 适用于需要频繁开大的流派或支援。 |

### 信物（主属性：全属性 / 减伤 / 护盾强度）

| 名称 | 推荐等级 | 主属性（凡品·40 级） | 定位说明 |
| --- | --- | --- | --- |
| 青松令牌 | 35-45 | 全属性 +56.3 | 给予全面属性提升，便于新手平均发展。 |
| 铁幕战旗 | 35-45 | 减伤 +17.1% | 让前排职业获得额外生存力。 |
| 灵泉佩符 | 35-45 | 护盾强度 +20.6% | 配合护盾技能或护具提高护盾收益。 |

### 傀儡（主属性：反击率 / 护盾强度 / 召唤物强度）

| 名称 | 推荐等级 | 主属性（凡品·40 级） | 定位说明 |
| --- | --- | --- | --- |
| 铜骨守卫 | 35-45 | 反击率 +17.1% | 为反击流提供额外触发来源。 |
| 雾织护灵 | 35-45 | 护盾强度 +20.6% | 让傀儡提供的护盾更加稳固。 |
| 羽纹伶仆 | 35-45 | 召唤物强度 +21.2% | 引导召唤流体验召唤物成长。 |

### 法器（主属性：法攻 / 最终增伤 / 元素易伤）

| 名称 | 推荐等级 | 主属性（凡品·40 级） | 定位说明 |
| --- | --- | --- | --- |
| 星砂法尺 | 35-45 | 法术攻击 +247.8 | 平滑法术强度成长，配合法术技能。 |
| 紫烟浮灯 | 35-45 | 最终增伤 +10.1% | 术法爆发向法器，强化技能倍率。 |
| 焚息骨铃 | 35-45 | 元素易伤 +17.7% | 让玩家体验易伤机制，为火/雷系做准备。 |

### 秘宝（主属性：最终增伤 / 最终减伤 / 减伤）

| 名称 | 推荐等级 | 主属性（凡品·40 级） | 定位说明 |
| --- | --- | --- | --- |
| 破晓星盘 | 35-45 | 最终增伤 +10.1% | 通用输出秘宝，适配任意输出流派。 |
| 玄石镇符 | 35-45 | 最终减伤 +8.2% | 减轻爆发压力，适合坦克或辅助携带。 |
| 玉鳞护心 | 35-45 | 减伤 +17.1% | 面向团队副本的防御秘宝，提升整体承伤能力。 |
