...
- **核心玩法**：转盘砍价 + 会员（修仙境界）加成 + 分享助力追加抽奖，最低价可至 ¥1288。
...
3. **价格与权益**：展示原价与当前价、最低价提示、权益亮点；规则浮层提供砍价/售票约束。
4. **砍价转盘**：
   - 默认 3 次抽奖；依据当前修仙境界（realmOrder）加成：元婴及以上 +1，合体及以上 +2。
   - 转盘结果实时扣减票价并弹出结果 overlay，最低不低于 ¥1288。
5. **分享助力**：
...
- `cloudfunctions/activities/index.js` 内置 **BHK56 兜底活动** 与 `bargainConfig`：
  - 价格区间：¥3500 → ¥1288；默认抽奖 3 次；助力封顶 6 次；倒计时至 2025-12-01 24:00（北京时间）。
...
- 规则浮层：汇总最低价、境界加成、助力上限、库存限制等关键信息，减轻用户疑惑。
