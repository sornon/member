...
悟性在判定时为所有掉落统一追加最高 2% 的加成：`baseChance + min(0.02, 悟性 × 0.00015)`，因此炼气玩家将悟性提至 60 左右时，普通层爆率可从 12% 提升到约 13%；若能维持更高悟性，则能稳固在 12% ~ 14% 区间内微幅提升掉落概率。【F:cloudfunctions/pve/index.js†L8683-L8702】
